...
4. **Light DOM for Styling:** Every component must include `createRenderRoot() { return this; }` to allow css classes to work inside the template.
5. **Styling Framework:** Use Bulma utility classes.
...
Use @{file_search} and @{read_file} tools to analyze package.json and my-app.js before we start coding.
